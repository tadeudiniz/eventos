...
<head>
    <?php $title = "Export Data Datatables"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Datatables"; $title = "Export Data"; include('partials/page-title.php'); ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/reference/button/" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
    ...
    <!-- Page js -->
    <script src="assets/js/pages/datatables-export-data.js"></script>
