...
<head>
    <?php $title = "Checkbox Select Datatables"; include('partials/title-meta.php'); ?>

    <!-- Datatables css -->
    <link href="assets/plugins/datatables/select.bootstrap5.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "DataTables"; $title = "Checkbox Select"; include('partials/page-title.php'); ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/extensions/select/examples/checkbox/checkbox.php" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
    ...
    <!-- Page js -->
    <script src="assets/js/pages/datatables-checkbox-select.js"></script>
