<!DOCTYPE html>
<html lang="en" data-menu-color="dark" data-topbar-color="light">

<head>
    <?php $title = "Dark Menu"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                <?php $title = "Dark Menu"; include('partials/page-title.php'); ?>
