...
<head>
    <?php $title = "Create Invoice"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Invoices"; $title = "Create Invoice"; include('partials/page-title.php'); ?>
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                ...
                                                <div class="border rounded position-relative d-flex text-center align-items-center justify-content-between px-2" style="height: 60px; width: 260px;">
                                                    ...
                                                    <img id="preview" src="assets/images/logo-black.png" alt="Company Logo" height="28">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" id="invoiceDate" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" placeholder="Select Date">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="dueDate" class="form-label">Due Date</label>
                                                    <input type="text" id="dueDate" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" placeholder="Select Date">
                                                </div>
                                                <div class="col-md-4">
