...
<head>
    <?php $title = "Apex Area Charts"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Charts"; $title = "Area Apexchart"; include('partials/page-title.php'); ?>
                                ...
                                <div dir="ltr">
                                    ...
                                    <div class="pt-2 pb-1">
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            <img src="assets/images/logo-sm.png" alt="file-image" height="24">
                                            <a href="javascript:void(0);" class="text-muted fw-bold fs-md">MyAdmin</a>
                                        </div>
                                    </div>
    ...
    <script src="assets/js/pages/chart-apex-area.js"></script>
