...
<head>
    <?php $title = "Fixed Header Datatables"; include('partials/title-meta.php'); ?>

    <!-- Datatables css -->
    <link href="assets/plugins/datatables/responsive.bootstrap5.min.css" rel="stylesheet" type="text/css">
    <link href="assets/plugins/datatables/fixedHeader.bootstrap5.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "DataTables"; $title = "Fixed Header"; include('partials/page-title.php'); ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/extensions/fixedheader/examples/styling/bootstrap5.php" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
    ...
    <!-- Page js -->
    <script src="assets/js/pages/datatables-fixed-header.js"></script>
