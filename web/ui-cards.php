...
<head>
    <?php $title = "Cards"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "UI"; $title = "Cards"; include('partials/page-title.php'); ?> 
                    ...
                    <div class="col-md-4">
                        <div class="card text-bg-dark border-0">
                            ...
                            <div class="card-body">
                                <p class="card-text">With supporting text below as a natural lead-in to
                                    additional content.</p>
                                <a href="javascript: void(0);" class="btn btn-sm btn-light">Go somewhere</a>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="card card-bordered">
                            <div class="card-body">
                                ...
                                <p class="card-text">With supporting text below as a natural lead-in to
                                    additional content.</p>
                                <a href="javascript: void(0);" class="btn btn-dark btn-sm">Button</a>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="row g-0 align-items-center">
                                <div class="col-md-4">
                                    <img src="assets/images/stock/small-1.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-md-4">
                                    <img src="assets/images/stock/small-2.jpg" class="img-fluid rounded-end" alt="...">
                                </div> <!-- end col -->
                            </div> <!-- end row-->
                        </div> <!-- end card -->
                    </div> <!-- end col-->
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <img src="assets/images/stock/small-3.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <img src="assets/images/stock/small-4.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title mb-2"><a href="#" class="text-primary stretched-link">Card with
                                        stretched link</a></h5>
                                <p class="card-text">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <img src="assets/images/stock/small-5.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title mb-2">Card with stretched link</h5>
                                <a href="#" class="btn btn-primary mt-2 stretched-link">Go somewhere</a>
                            </div> <!-- end card-body -->
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <img src="assets/images/stock/small-6.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title mb-2"><a href="#" class="text-primary stretched-link">Card with stretched link</a>
                                </h5>
                                <p class="card-text">
                                    Some quick example text to build on the card up the bulk of the card's content.
                                </p>
                    ...
                    <div class="col-12">
                        <div class="card-group mb-3">
                            <div class="card d-block">
                                <img class="card-img-top" src="assets/images/stock/small-8.jpg" alt="Card image cap">
                                <div class="card-body">
                            ...
                            <div class="card d-block">
                                <img class="card-img-top" src="assets/images/stock/small-9.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Card title</h5>
                            ...
                            <div class="card d-block">
                                <img class="card-img-top" src="assets/images/stock/small-10.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Card title</h5>
                                    <p class="card-text">This is a wider card with supporting text below as a
