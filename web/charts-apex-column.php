...
<head>
    <?php $title = "Apex Column Charts"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Charts"; $title = "Column Apexchart"; include('partials/page-title.php'); ?>
    ...
    <script src="assets/js/pages/chart-apex-column.js"></script>
