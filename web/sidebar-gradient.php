<!DOCTYPE html>
<html lang="en" data-menu-color="gradient" data-topbar-color="light">

<head>
    <?php $title = "Gradient Menu"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                <?php $title = "Gradient Menu"; include('partials/page-title.php'); ?>
