...
<head>
    <?php $title = "i18 Support"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $title = "i18 Support"; $subtitle = "Miscellaneous"; include('partials/page-title.php'); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="it">
                                <img src="assets/images/flags/it.svg" alt="user-image" class="me-1 rounded" height="18" data-translator-image> <span class="align-middle">Italian</span>
                            </button>

                            <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="es">
                                <img src="assets/images/flags/es.svg" alt="user-image" class="me-1 rounded" height="18" data-translator-image> <span class="align-middle">Spanish</span>
                            </button>

                            <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="ru">
                                <img src="assets/images/flags/ru.svg" alt="user-image" class="me-1 rounded" height="18" data-translator-image> <span class="align-middle">Russian</span>
                            </button>
                        </div>
