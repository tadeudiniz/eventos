...
<head>
    <?php $title = "Seller Details"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Ecommerce"; $title = "Seller Details"; include('partials/page-title.php'); ?>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center rounded border-light p-2 bg-light-subtle border">
                                    <div class="d-flex justify-content-start align-items-center gap-3">
                                        <div class="avatar avatar-xl">
                                            <img src="assets/images/sellers/1.png" alt="avatar-store" class="img-fluid rounded-circle">
                                        </div>
                                        <div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <p class="mb-0 fs-sm">Support: <a href="mailto:help@machubstore.com" class="text-primary fw-semibold">help@machubstore.com</a></p>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <p class="mb-0 fs-sm">Website: <a href="https://www.machubstore.com" class="text-primary fw-semibold">www.machubstore.com</a></p>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h5 class="mb-0 fw-normal">
                                                                    <a data-sort="product" href="ecommerce-product-details.php" class="link-reset">Vintage
                                                                        Leather Wallet</a>
                                                                </h5>
                                                            </div>
                                                        </div>
    ...
    <script src="assets/js/pages/ecommerce-seller-details.js"></script>
