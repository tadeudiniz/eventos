...
<head>
    <?php $title = "Range Search"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "DataTables"; $title = "Range Search"; include('partials/page-title.php'); ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/examples/plug-ins/range_filtering.php" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="range-search-data" class="table table-striped dt-responsive align-middle mb-0">
    ...
    <!-- Page js -->
    <script src="assets/js/pages/datatables-range-search.js"></script>
