...
<head>
    <?php $title = "Range Apexcharts"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Charts"; $title = "Range Apexcharts"; include('partials/page-title.php'); ?>
    ...
    <script src="assets/js/pages/chart-apex-range.js"></script>
