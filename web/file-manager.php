...
<head>
    <?php $title = "File Manager"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "File Manager"; include('partials/page-title.php'); ?>
                        ...
                        <div class="card h-100 mb-0 rounded-0 border-0" data-simplebar>
                            <div class="card-body">
                                ...
                                <div class="list-group list-group-flush list-custom mt-3">
                                    <a href="file-manager.php" class="list-group-item list-group-item-action active">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="d-flex align-items-center justify-content-between gap-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-1 fs-sm"><a href="#!" class="link-reset">MyAdmin
                                                            Multi</a></h5>
                                                ...
                                                <div class="dropdown flex-shrink-0 text-muted">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a href="assets/images/users/user-1.jpg" download class="dropdown-item"><i class="ti ti-download me-1"></i>
                                                            Download</a>
                                ...
                                <table class="table table-custom table-select mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-5.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-7.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-6.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-4.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-2.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-3.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-5.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                </div>
                                            </td>
                                            <td class="text-end pe-3">
                                                <div class="d-flex align-items-center justify-content-end gap-2">
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-share me-1"></i> Share</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                            <a href="assets/images/users/user-4.jpg" download class="dropdown-item"><i class="ti ti-download me-1"></i>
                                                                Download</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-pin me-1"></i> Pin</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-edit me-1"></i> Edit</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-1.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-3.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-6.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-9.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                </div>
                                            </td>
                                            <td class="text-end pe-3">
                                                <div class="d-flex align-items-center justify-content-end gap-2">
                                                ...
                                                <div class="d-flex align-items-center justify-content-end gap-2">
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-share me-1"></i> Share</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                            <a href="assets/files/proposal.pdf" download class="dropdown-item"><i class="ti ti-download me-1"></i>
                                                                Download</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-pin me-1"></i> Pin</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-edit me-1"></i> Edit</a>
                                                            <a href="#" data-table-delete-row class="dropdown-item"><i class="ti ti-trash me-1"></i> Delete</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-4.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-8.jpg" alt="" class="rounded-circle avatar-xs"></div>
                                                </div>
                                            </td>
                                            <td class="text-end pe-3">
                                                <div class="d-flex align-items-center justify-content-end gap-2">
                                                ...
                                                <div class="d-flex align-items-center justify-content-end gap-2">
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-share me-1"></i> Share</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                            <a href="assets/files/dependency.dep" download class="dropdown-item"><i class="ti ti-download me-1"></i>
                                                                Download</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-pin me-1"></i> Pin</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-edit me-1"></i> Edit</a>
                                                            <a href="#" data-table-delete-row class="dropdown-item"><i class="ti ti-trash me-1"></i> Delete</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    ...
                                                    <div class="avatar">
                                                        <img src="assets/images/users/user-9.jpg" alt="" class="rounded-circle avatar-xs">
                                                    </div>
                                                    <div class="avatar">
                                                        <img src="assets/images/users/user-10.jpg" alt="" class="rounded-circle avatar-xs">
                                                    </div>
                                                    <div class="avatar">
                                                        <img src="assets/images/users/user-3.jpg" alt="" class="rounded-circle avatar-xs">
                                                    </div>
                                                    <div class="avatar">
                                                        <img src="assets/images/users/user-8.jpg" alt="" class="rounded-circle avatar-xs">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-end pe-3">
                                                <div class="d-flex align-items-center justify-content-end gap-2">
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-share me-1"></i> Share</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-link me-1"></i> Get Sharable Link</a>
                                                            <a href="assets/images/users/user-6.jpg" download class="dropdown-item"><i class="ti ti-download me-1"></i>
                                                                Download</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-pin me-1"></i> Pin</a>
                                                            <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-edit me-1"></i> Edit</a>
                                                            <a href="#" data-table-delete-row class="dropdown-item"><i class="ti ti-trash me-1"></i> Delete</a>
