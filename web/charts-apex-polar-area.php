...
<head>
    <?php $title = "Polar Area Apexcharts"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Charts"; $title = "Ploar Area Apexchart"; include('partials/page-title.php'); ?>
    ...
    <script src="assets/js/pages/chart-apex-polar-area.js"></script>
