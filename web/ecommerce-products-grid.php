...
<head>
    <?php $title = "Products Grid"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Ecommerce"; $title = "Products Grid"; include('partials/page-title.php'); ?>
                        ...
                        <form class="bg-light-subtle rounded border p-3">
                            <div class="d-flex flex-wrap justify align-items-center gap-3">
                                ...
                                <div class="d-flex gap-1">
                                    <a href="ecommerce-products-grid.php" class="btn btn-primary btn-icon">
                                        <i data-lucide="layout-grid" class="fs-lg"></i>
                                    </a>
                                    <a href="ecommerce-products.php" class="btn btn-soft-primary btn-icon">
                        ...
                        <div class="row row-cols-xxl-4 row-cols-lg-3 row-cols-sm-2 row-col-1 g-2">
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/1.png" alt="modern-sofa" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Modern Minimalist Fabric Sofa Single Seater</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(45)</a></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/2.png" alt="funky-shoes" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Funky Streetwear Sneakers - Neon Splash</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(32)</a></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/3.png" alt="earbuds" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Noise Canceling Wireless Earbuds - Black Edition</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(58)</a></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/4.png" alt="wooden-chair" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Minimalist Solid Wood Dining Chair</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(46)</a></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/5.png" alt="black-wall-watch" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Modern Black Minimalist Wall Clock</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(62)</a></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/6.png" alt="brown-chair" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Elegant Brown Wooden Chair</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(48)</a></span>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/7.png" alt="imac" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Apple iMac 24" Retina 4.5K Display</a>
                                        </h6>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/8.png" alt="coolest-chair" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Coolest Ergonomic Lounge Chair</a>
                                        </h6>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/9.png" alt="ipad" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Apple iPad 10.9" Wi-Fi 64GB - Silver</a>
                                        </h6>
                            ...
                            <div class="col">
                                <article class="card h-100 mb-2">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="p-3">
                                            <img src="assets/images/products/10.png" alt="ipad" class="img-fluid">
                                        </div>
                                        <!-- Title -->
                                        <h6 class="card-title fs-sm lh-base mb-2">
                                            <a href="ecommerce-product-details.php" class="link-reset">Branded Bagpack - Multicolor</a>
                                        </h6>
                                        ...
                                        <div>
                                            ...
                                            <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(23)</a></span>
                                        </div>
                                    </div>
