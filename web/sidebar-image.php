<!DOCTYPE html>
<html lang="en" data-menu-color="image" data-topbar-color="light">

<head>
    <?php $title = "Image Menu"; include('partials/title-meta.php'); ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                <?php $title = "Image Menu"; include('partials/page-title.php'); ?>
