...
<head>
    <?php $title = "Show & Hide Columns Datatables"; include('partials/title-meta.php'); ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Datatables"; $title = "Show & Hide Columns"; include('partials/page-title.php'); ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/examples/api/show_hide.php" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="show-hide-column" class="table table-striped dt-responsive align-middle mb-0">
    ...
    <!-- Page js -->
    <script src="assets/js/pages/datatables-show-hide-columns.js"></script>
